...
image. The default image is based on Raspberry Pi OS Lite 64-bit and is intended for
...
```bash
WISP_PI_GEN_BRANCH=master bash scripts/build_pi_image.sh  # optional 32-bit local build
